...
INSERT INTO `plant` (`F_ID`, `name`, `price`, `description`, `R_ID`, `images_path`, `options`) VALUES
...
INSERT INTO `orders` (`order_ID`, `F_ID`, `plantname`, `price`, `quantity`, `order_date`, `username`, `R_ID`) VALUES
...
INSERT INTO `plants` (`R_ID`, `name`, `email`, `contact`, `address`, `M_ID`) VALUES
...
ALTER TABLE `plant`
  ADD CONSTRAINT `plant_ibfk_1` FOREIGN KEY (`R_ID`) REFERENCES `plants` (`R_ID`);

--

--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`F_ID`) REFERENCES `plantname` (`F_ID`),
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`username`) REFERENCES `customer` (`username`),
  ADD CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`R_ID`) REFERENCES `plants` (`R_ID`);

--
-
--
ALTER TABLE `plants`
  ADD CONSTRAINT `plants_ibfk_1` FOREIGN KEY (`M_ID`) REFERENCES `manager` (`username`);
COMMIT;
