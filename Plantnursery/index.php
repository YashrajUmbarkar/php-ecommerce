...
<html>
  ...
  <head>
    <title> Home | Plant Nursery </title>
  </head>
...
?>
    ...
    <div class="wide">
      	<div class="col-xs-3 line"><hr></div>
        <div class="col-xs-6 logo"><img width="500px" src="images/LogoImage.png"></div>
        <div class="col-xs-3 line"><hr></div>
        
    </div>
    <br>
    <div class="orderblock">
    <h2>Have a look at our collection of plants</h2>
    <center><a class="btn btn-success btn-lg" href="customerlogin.php" role="button" >I am interested</a></center>
    </div>
