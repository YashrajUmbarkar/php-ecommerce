...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="css/edit_p_items.css">
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="edit_p_items.php" class="list-group-item active">Edit Items</a>
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    $query = mysqli_query($conn, "UPDATE plant set
    name='$name', price='$price',
    description='$description' where F_ID='$F_ID'");
    }
    $query = mysqli_query($conn, "SELECT * FROM plant f WHERE f.R_ID IN (SELECT r.R_ID FROM PLANTS r WHERE r.M_ID='$user_check') ORDER BY F_ID");
    while ($row = mysqli_fetch_array($query)) {
      ...
      <div class="list-group" style="text-align: center;">
        <?php
      echo "<b><a href='edit_p_items.php?update= {$row['F_ID']}'>{$row['name']}</a></b>";  
        ?>
      </div>
    ...
    $update = $_GET['update'];
    $query1 = mysqli_query($conn, "SELECT * FROM plant WHERE F_ID=$update");
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="edit_p_items.php" method="GET">
        <br style="clear: both">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="dname" name="dname" value=<?php echo $row1['name'];  ?> placeholder="Your name" required="">
          </div>     

          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Price: </label>
            <input type="text" class="form-control" id="dprice" name="dprice" value=<?php echo $row1['price'];  ?> placeholder="Your Price (INR)" required="">
          </div>

          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Description: </label>
            <input type="text" class="form-control" id="ddescription" name="ddescription" value=<?php echo $row1['description'];  ?> placeholder="Your Description" required="">
          </div>
