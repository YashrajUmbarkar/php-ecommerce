...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="css/delete_p_items.css">
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="delete_p_items.php" class="list-group-item active">Delete Items</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="delete_p_items1.php" method="POST">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> DELETE YOUR PLANT ITEMS FROM HERE </h3>
...
$sql = "SELECT * FROM plant f WHERE f.options = 'ENABLE' AND f.R_ID IN (SELECT r.R_ID FROM PLANTS r WHERE r.M_ID='$user_check') ORDER BY F_ID";
